    ...
    case 0:
    {
        ...
        if( isset($request['ACC_UKEY']) )
        {
            ...
            if(INPUT_CONTENT_LOG_ABLE > 0 )
                log_input("[RECV][ITEM_FLEA_BASKET_BUY_GAIN_INFO] "  . print_r($request , true) );
            ...
            try 
            {
                ...
                $query = "CALL GET_RW_ITEM_FLEA_BASKET_BUY_GAIN_INFO(@RETURN,?)";
                ...
                $stmt->execute();
                 ...
                 /*   
                $Result_RW_Item_Flea_Basket_Buy_Gain_info = array();
                while ($row = $stmt->fetch())
                {
                    $Result_RW_Item_Flea_Basket_Buy_Gain_info["FLEA_COIN"]       =  $row[0];
                    $Result_RW_Item_Flea_Basket_Buy_Gain_info["FLEA_ITEM_NUM"]   =  $row[1];
                } 
                */
                ...
                switch(GET_QUERY_RETURN_VALUE($Main_Db, $stmt->nextRowset(),$stmt->columnCount() ))
                {
                    ...
                    case 0:
                    {
                        ...
                        //$response['ITEM_FLEA_BASKET_BUY_GAIN_INFO'] = $Result_RW_Item_Flea_Basket_Buy_Gain_info; 
