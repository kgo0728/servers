    ...
    case 0:
    {
        ...
        if( isset($request['IT_UKEY']) )
        {
            ...
            if(INPUT_CONTENT_LOG_ABLE > 0 )
                log_input("[RECV][ITEM_LUCK_CARD_INVEN_DISCARD_INFO] "  . print_r($request , true) );
            ...
            try 
            {
                ...
                $query = "CALL GET_RW_ITEM_LUCK_CARD_INVEN_DISCARD_INFO(@RETURN,?,?)";
                ...
                $Result_RW_Item_Luck_Card_Inven_Discard_info = array();
                while ($row = $stmt->fetch())
                {
                    $Result_RW_Item_Luck_Card_Inven_Discard_info["DEL_ITEM_UKEY"]      = (string)$row[0];
                ...
                switch(GET_QUERY_RETURN_VALUE($Main_Db, $stmt->nextRowset(),$stmt->columnCount() ))
                {
                    ...
                    case 0:
                    {
                        ...
                        $response['ITEM_LUCK_CARD_INVEN_DISCARD_INFO'] = $Result_RW_Item_Luck_Card_Inven_Discard_info; 
